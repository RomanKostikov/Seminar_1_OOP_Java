...
public class Main {
    public static void main(String[] args) {
        ...
        List<BottleOfWater> bw = new ArrayList<>(Arrays.asList(new BottleOfWater("pepsi", 42), new BottleOfWater("sprite", 67), new BottleOfWater("cola", 70), new BottleOfWater("sprite", 40), new BottleOfWater("sprite", 150)));
        vm.initProduct(bw);
